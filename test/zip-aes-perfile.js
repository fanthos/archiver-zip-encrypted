...
describe('zip-aes-perfile', () => {
    ...
    it('should pack empty file with zip-aes and unpack with 7z', (done) => {
        let archive = archiver.create('zip-encrypted', {zlib: {level: 0}, encryptionMethod: 'aes256'});
    ...
    it('should pack directory with zip-aes and unpack with 7z', (done) => {
        let archive = archiver.create('zip-encrypted', {zlib: {level: 8}, encryptionMethod: 'aes256'});
        archive.directory('./test/resources/dir', 'dir', {password: '123'});
        archive.finalize();
